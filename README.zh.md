...
> **Skills 归属**:捆绑的 20 个技能中,14 个源自 [Superpowers 方法论](https://github.com/obra/superpowers)(MIT),6 个源自 [Ponytail](https://github.com/DietrichGebert/ponytail)(MIT),署名声明见 `preset/programming/skills/SKILLS-LICENSE.md`。
